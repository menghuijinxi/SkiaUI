...
if(VCPKG_TARGET_IS_WINDOWS)
    ...
    if(DEFINED VCPKG_PLATFORM_TOOLSET_VERSION)
        string(APPEND OPTIONS " win_toolchain_version=\"${VCPKG_PLATFORM_TOOLSET_VERSION}\"")
    endif()
...
string(REPLACE "-Z7" "" VCPKG_COMBINED_C_FLAGS_RELEASE "${VCPKG_COMBINED_C_FLAGS_RELEASE}")
string(REPLACE "-Z7" "" VCPKG_COMBINED_CXX_FLAGS_RELEASE "${VCPKG_COMBINED_CXX_FLAGS_RELEASE}")
string(REPLACE "/Z7" "" VCPKG_COMBINED_C_FLAGS_RELEASE "${VCPKG_COMBINED_C_FLAGS_RELEASE}")
string(REPLACE "/Z7" "" VCPKG_COMBINED_CXX_FLAGS_RELEASE "${VCPKG_COMBINED_CXX_FLAGS_RELEASE}")
string(APPEND VCPKG_COMBINED_C_FLAGS_RELEASE " /Zo-")
string(APPEND VCPKG_COMBINED_CXX_FLAGS_RELEASE " /Zo-")
